...
export const selectAllFridge = () => {
	return new Promise((resolve, reject) => {
		pool.query('SELECT f.FridgeID, t.IngredientTagID, t.Name as IngredientName, d.Color as DeptColor, d.Name as DeptName FROM FRIDGE f JOIN INGREDIENT_TAG t on f.IngredientTagID = t.IngredientTagID JOIN INGREDIENT_DEPARTMENT d on t.IngredientDepartmentID = d.IngredientDepartmentID ORDER BY d.Position, t.Name', (error, result) => {
			if (error) {
